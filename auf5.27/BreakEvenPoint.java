...
public class BreakEvenPoint
{
   ...
   {
      int verkaufspreisst  = 1500; // Verkaufspreis pro Stück
      int rohstoffkostenst = 600;  // Rohstoffkosten pro Stück
      int arbeitskostenst  = 400;  // Arbeitskosten pro Stück
      int fixkosten        = 5000; // Fixkosten pro Stück  
